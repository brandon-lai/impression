...
async function loadSentiment() {
  if (table2) return;
  if (!inflight) {
    inflight = Promise.resolve().then(() => (init_vader_data(), vader_data_exports)).then(({ PACKED: PACKED2 }) => {
      const m = /* @__PURE__ */ new Map();
      for (const pair of PACKED2.split(",")) {
...
var sentimentReady = () => table2 !== null;
var BOOSTERS = {
  absolutely: 0.293,
  amazingly: 0.293,
  completely: 0.293,
